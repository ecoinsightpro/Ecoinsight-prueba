...
const NEWS = [
  {
    id:101, region:'internacional', cat:'Regulación', src:'Cleary Gottlieb', url:'https://www.clearygottlieb.com/news-and-insights/publication-listing/climate-energy-eu-policy-regulation-update-2026-09-02', date:'02 Sep 2026', time:'1 sem', read:'4 min', th:'report', featured:true,
    title:{es:'GHG Protocol e ISO anuncian un estándar único de contabilidad de carbono',
           en:'GHG Protocol and ISO announce a single unified carbon accounting standard'},
    summary:{es:'Los dos marcos más usados del mundo convergerán en una sola norma de cuantificación de emisiones, terminando con la duplicidad metodológica entre GHG Protocol e ISO 14064.',
             en:'The world\u2019s two most used frameworks will converge into a single emissions quantification standard, ending the methodological overlap between the GHG Protocol and ISO 14064.'},
    impactChile:{es:'HuellaChile y las verificaciones bajo ISO 14064 quedarán alineadas con el GHG Protocol, simplificando la acreditación de inventarios.',
                 en:'HuellaChile and ISO 14064 verifications will align with the GHG Protocol, simplifying inventory accreditation.'},
    impactEmpresas:{es:'Un solo estándar reduce el retrabajo: el mismo inventario servirá para reportes locales, auditorías y requerimientos de clientes internacionales.',
                    en:'A single standard cuts rework: the same inventory will serve local reports, audits and international client requirements.'},
    body:{es:['La convergencia responde a una demanda de larga data de empresas y verificadores, que hasta ahora debían conciliar dos marcos con criterios distintos de límites organizacionales y de Alcance 3.',
              'Para consultoras, implica que las metodologías y plantillas de cálculo tendrán una base normativa común, con menos ajustes por cliente o jurisdicción.'],
          en:['The convergence answers a long-standing demand from companies and verifiers, who until now had to reconcile two frameworks with different criteria for organizational boundaries and Scope 3.',
              'For consultancies, it means calculation methodologies and templates will share a common normative basis, with fewer client- or jurisdiction-specific adjustments.']},
  },
  {
    id:102, region:'internacional', cat:'Regulación', src:'Carbon Intelligence', url:'https://carbonintelligence.green/blog/omnibus-csrd-carbon-measurement/', date:'02 Sep 2026', time:'1 sem', read:'5 min', th:'carbon',
    title:{es:'La UE prohíbe las declaraciones ambientales sin respaldo: el sello "carbono neutral" exige verificación acreditada',
           en:'The EU bans unsubstantiated environmental claims: the \u201ccarbon neutral\u201d label now requires accredited verification'},
    summary:{es:'Desde el 27 de septiembre de 2026, la Directiva UE 2024/825 prohíbe las afirmaciones ambientales genéricas y obliga a sustentar todo sello de neutralidad con datos verificados por un tercero acreditado.',
             en:'From 27 September 2026, EU Directive 2024/825 bans generic environmental claims and requires every neutrality label to be backed by data verified by an accredited third party.'},
    impactChile:{es:'Los exportadores chilenos que comuniquen neutralidad en mercados europeos deberán acreditar su inventario, no solo declararlo.',
                 en:'Chilean exporters communicating neutrality in European markets will need to accredit their inventory, not merely declare it.'},
    impactEmpresas:{es:'Sin un inventario trazable y verificable, el marketing ambiental pasa de activo a riesgo legal y sancionatorio.',
                    en:'Without a traceable, verifiable inventory, environmental marketing shifts from an asset to a legal and enforcement risk.'},
    body:{es:['La norma apunta al greenwashing: ya no basta con compensar emisiones y comunicarlo, hay que demostrar el cálculo con evidencia documental y metodología reconocida.',
              'En la práctica, el cumplimiento comienza por la medición: un inventario de Alcances 1, 2 y 3 con factores referenciados y trazabilidad por fuente.'],
          en:['The rule targets greenwashing: offsetting emissions and announcing it is no longer enough \u2014 the calculation must be demonstrated with documentary evidence and a recognized methodology.',
              'In practice, compliance starts with measurement: a Scope 1, 2 and 3 inventory with referenced factors and source-level traceability.']},
  },
  {
    id:103, region:'chile', cat:'Clima', src:'Corporación Alta Ley', url:'https://www.corporacionaltaley.cl/chile-carbon-forum-2026-de-las-metas-climaticas-a-las-decisiones-de-inversion/', date:'04 Sep 2026', time:'1 sem', read:'6 min', th:'carbon',
    title:{es:'Chile Carbon Forum 2026: de las metas climáticas a las decisiones de inversión',
           en:'Chile Carbon Forum 2026: from climate targets to investment decisions'},
    summary:{es:'La tercera edición del foro se realizará el 6 y 7 de octubre en la Universidad de Chile. El diagnóstico de los organizadores: el desafío ya no está en los Alcances 1 y 2, sino en la calidad y trazabilidad del Alcance 3.',
             en:'The forum\u2019s third edition takes place on 6 and 7 October at Universidad de Chile. The organizers\u2019 diagnosis: the challenge is no longer Scopes 1 and 2, but the quality and traceability of Scope 3.'},
    impactChile:{es:'El estándar sube rápido con IFRS S2, la integración de GHG Protocol e ISO y mayores exigencias de HuellaChile.',
                 en:'The bar is rising fast with IFRS S2, the integration of GHG Protocol and ISO, and stricter HuellaChile requirements.'},
    impactEmpresas:{es:'Se exige pasar de inventarios para reportar a sistemas para gestionar la descarbonización, con costos de reducción por fuente.',
                    en:'Companies must move from inventories built to report to systems built to manage decarbonization, with abatement costs per source.'},
    body:{es:['Según los organizadores, la base está consolidada en las grandes compañías que llevan años midiendo, pero el estándar de cuantificación y verificación está subiendo con rapidez.',
              'El foco del foro será el Alcance 3: completitud de datos, verificabilidad y la capacidad de vincular el inventario con decisiones concretas de inversión y reducción.'],
          en:['According to the organizers, the groundwork is consolidated among large companies that have measured for years, but the quantification and verification standard is rising quickly.',
              'The forum will focus on Scope 3: data completeness, verifiability and the ability to link the inventory to concrete investment and abatement decisions.']},
  },
  {
    id:104, region:'internacional', cat:'ESG', src:'IFRS Foundation', url:'https://www.clearygottlieb.com/news-and-insights/publication-listing/climate-energy-eu-policy-regulation-update-2026-09-02', date:'02 Sep 2026', time:'1 sem', read:'3 min', th:'report',
    title:{es:'El ISSB abre a consulta la actualización de su taxonomía de divulgación de sostenibilidad',
           en:'The ISSB opens its sustainability disclosure taxonomy update for consultation'},
    summary:{es:'La propuesta de cambios a la IFRS Sustainability Disclosure Taxonomy recibe comentarios de las partes interesadas hasta el 28 de septiembre de 2026.',
             en:'The proposed changes to the IFRS Sustainability Disclosure Taxonomy are open for stakeholder comment until 28 September 2026.'},
    impactChile:{es:'Chile adoptó las NIIF S1 y S2 vía CMF, por lo que los ajustes de taxonomía llegarán a los reportes de emisores locales.',
                 en:'Chile adopted IFRS S1 and S2 through the CMF, so taxonomy adjustments will reach local issuers\u2019 reports.'},
    impactEmpresas:{es:'Los datos de emisiones deberán poder etiquetarse en formato digital comparable, lo que exige estructura desde la hoja de cálculo.',
                    en:'Emissions data will need to be taggable in a comparable digital format, which demands structure from the spreadsheet up.'},
    body:{es:['La taxonomía define cómo se etiquetan digitalmente las divulgaciones de sostenibilidad para que inversionistas y reguladores puedan compararlas entre mercados.',
              'Para quienes preparan inventarios, la señal es clara: los datos desordenados dejan de ser viables cuando el reporte debe ser legible por máquina.'],
          en:['The taxonomy defines how sustainability disclosures are digitally tagged so investors and regulators can compare them across markets.',
              'For those preparing inventories the signal is clear: disorganized data stops being viable once the report must be machine-readable.']},
  },
  {
    id:1, cat:'Regulación', src:'El Desconcierto', url:'https://eldesconcierto.cl/hoja-ruta/chile-mejora-el-estandar-esg-brechas-empresas-el-cumplimiento-nuevas-exigencias-reporte-n5458729', date:'12 May 2026', time:'1 mes', read:'5 min', th:'report', image:'https://media.eldesconcierto.cl/p/552f7f09ae15460d2a74e9a2263d2553/adjuntos/378/imagenes/100/128/0100128637/1200x675/581x453:601x473/gestionar-la-sostenibilidad-foto-icorp.jpg',
  ...
  {
    id:2, cat:'ESG', src:'ESG Hoy', url:'https://www.esghoy.cl/chile-33-empresas-sustainability-yearbook-2026/', date:'23 Feb 2026', time:'2 meses', read:'3 min', th:'esg', image:'https://www.esghoy.cl/wp-content/uploads/2026/02/StockCake-Iniciativa_de_Jardineria_Corporativa-549550-medium.webp',
  ...
  {
    id:3, cat:'ESG', src:'Tiempos Sustentables', url:'https://tiempossustentables.cl/2026/06/09/grieta-esg-chile-regulacion-empresa-2026/', date:'09 Jun 2026', time:'4 días', read:'6 min', th:'esg', image:'https://i0.wp.com/tiempossustentables.cl/wp-content/uploads/2026/06/tiempos-sustentables-1.jpg?fit=1200%2C675&ssl=1',
  ...
  {
    id:4, cat:'ESG', src:'24Horas', url:'https://www.24horas.cl/actualidad/economia/nuevo-estandar-del-mercado-sostenibilidad-pasa-de-ser-reputacion-a-un', date:'28 May 2026', time:'2 sem', read:'4 min', th:'report', image:'https://www.24horas.cl/24horas/site/artic/20260530/imag/foto_0000000720260530111228/Captura_de_pantalla_2026-05-30_111821.webp',
  ...
  {
    id:5, cat:'Energía', src:'Reporte Minero', url:'https://www.reporteminero.cl/noticia/noticias/2026/01/chile-hoja-ruta-transicion-energetica-2050-iea', date:'15 Ene 2026', time:'5 meses', read:'5 min', th:'inventory', image:'https://www.reporteminero.cl/files/6968e4d435a36_1200x719.jpg',
  ...
  {
    id:6, cat:'Minería', src:'Minería & Desarrollo', url:'https://www.mineriaydesarrollo.com/noticias/2026/05/19/24459-estiman-que-para-2030-la-mineria-del-cobre-en-chile-operara-con-99por_ciento-de-energia-renovable', date:'19 May 2026', time:'3 sem', read:'4 min', th:'carbon', image:'https://cdn4.mineriaydesarrollo.com/s4/2026/05/19/mineriaydesarrollo/images/26/45/264561_a640ef772d6af91083ffbf1075d4bf266c5bbaa133d30e1df4ac9ee7d0612f20/md.webp?_v=v3-43',
  ...
  {
    id:11, region:'internacional', cat:'Regulación', src:'European Commission', url:'https://taxation-customs.ec.europa.eu/carbon-border-adjustment-mechanism_en', date:'01 Jun 2026', time:'2 sem', read:'5 min', th:'inventory', image:'https://taxation-customs.ec.europa.eu/sites/default/files/styles/ewcms_metatag_image/public/2024-09/CBAM%20Cloud_Website%20Banner_Updated_0.png?h=502d804d&itok=_90aA0k4',
  ...
  {
    id:12, region:'internacional', cat:'Energía', src:'IEA', url:'https://www.iea.org/energy-system/renewables', date:'20 May 2026', time:'3 sem', read:'4 min', th:'esg', image:'https://iea.imgix.net/298dbf91-1765-4367-96bc-dc65b182f3be/RenewablesMarketUpdate2023_FLIPPED_shutterstock_366229667.jpg?auto=compress%2Cformat&fit=min&h=630&q=80&rect=0%2C467%2C4500%2C2533&w=1230',
  ...
  {
    id:13, region:'internacional', cat:'Clima', src:'UNEP', url:'https://www.unep.org/resources/emissions-gap-report-2025', date:'12 May 2026', time:'1 mes', read:'6 min', th:'plan', image:'https://cdn.unenvironment.org/styles/topics_content_promo/s3/2025-11/EGR%20web%20banner-SocialPreview.png?itok=qoclF64-',
  ...
  {
    id:15, region:'internacional', cat:'Minería', src:'IEA', url:'https://www.iea.org/reports/global-critical-minerals-outlook-2025', date:'15 Abr 2026', time:'2 meses', read:'5 min', th:'carbon', image:'https://iea.imgix.net/11ffb4ad-64bd-4b6a-9700-d144e5045e6b/GlobalCriticalMineralsOutlook2025_shutterstock_2317356159.jpg?auto=compress%2Cformat&fit=min&h=600&q=80&rect=1109%2C103%2C4686%2C4672&w=1200',
...
/* ═══════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════ */
window.ETSY_SHOP = {name:'EcoInsight', url:'https://www.etsy.com/es/shop/EcoInsight', rating:4.0, sales:12};
window.ETSY_FEED_URL = '';   // ← paste your serverless feed URL here to enable live auto-sync
window.ETSY_PRODUCTS = [
  {listingId:'4376732622', cat:'powerbi', group:'dashboard', edition:'es', shots:['https://i.etsystatic.com/62203228/r/il/d0db65/7953662985/il_794xN.7953662985_q08l.jpg','https://i.etsystatic.com/62203228/r/il/9ec587/7282035479/il_794xN.7282035479_slgu.jpg','https://i.etsystatic.com/62203228/r/il/898dcd/7282036661/il_794xN.7282036661_5e3v.jpg'], th:'esg', fmt:'Excel + Power BI', price:5.99, currency:'USD', bc:'accent',
    image:'https://i.etsystatic.com/62203228/r/il/d0db65/7953662985/il_794xN.7953662985_q08l.jpg',
    name:{es:'Panel Huella de Carbono · Alcance 1, 2 y 3', en:'Carbon Footprint Dashboard · Scope 1, 2 & 3'},
    desc:{es:'Dashboard en Excel + Power BI ideal para PYMEs. Monitorea y visualiza tu huella en tiempo real. Versión en español.', en:'Excel + Power BI dashboard, ideal for SMEs. Monitor and visualise your footprint in real time. Spanish edition.'},
  ...
  {listingId:'4373813587', cat:'powerbi', group:'dashboard', edition:'en', th:'esg', fmt:'Excel + Power BI', price:5.99, currency:'USD', bc:'accent2',
    image:'https://i.etsystatic.com/62203228/r/il/d0db65/7953662985/il_794xN.7953662985_q08l.jpg',
    name:{es:'Carbon Footprint Tracker · Alcance 1, 2 y 3 (inglés)', en:'Carbon Footprint Tracker · Scope 1, 2 & 3'},
    desc:{es:'Dashboard en Excel + Power BI para pymes. Versión en inglés.', en:'Excel + Power BI dashboard for small & medium businesses. English edition.'},
    url:{es:'https://www.etsy.com/es/listing/4373813587/carbon-footprint-tracker-dashboard-scope', en:'https://www.etsy.com/es/listing/4373813587/carbon-footprint-tracker-dashboard-scope'}},
  {listingId:'4443295460', cat:'excel', group:'calculator', edition:'es', shots:['https://i.etsystatic.com/62203228/r/il/26766f/7953634063/il_794xN.7953634063_rnog.jpg','https://i.etsystatic.com/62203228/r/il/f1e3f0/7953231067/il_794xN.7953231067_r0rk.jpg','https://i.etsystatic.com/62203228/r/il/66ac98/7905278026/il_794xN.7905278026_bjso.jpg'], th:'carbon', fmt:'Excel · GHG Protocol', price:7.49, oldPrice:9.99, currency:'USD', bc:'warning',
    image:'https://i.etsystatic.com/62203228/r/il/26766f/7953634063/il_794xN.7953634063_rnog.jpg',
    name:{es:'Calculadora Huella de Carbono · Excel', en:'Carbon Footprint Calculator · Excel'},
    desc:{es:'Plantilla GHG Protocol (Alcances 1, 2 y 3) para reporte ESG de Pymes. Versión en español.', en:'GHG Protocol template (Scopes 1, 2 & 3) for SME ESG reporting. Spanish edition.'},
  ...
  {listingId:'4447014903', cat:'excel', group:'calculator', edition:'en', th:'carbon', fmt:'Excel · GHG Protocol', price:7.49, oldPrice:9.99, currency:'USD', bc:'warning',
    image:'https://i.etsystatic.com/62203228/r/il/26766f/7953634063/il_794xN.7953634063_rnog.jpg',
    name:{es:'Carbon Footprint Calculator · Excel (inglés)', en:'Carbon Footprint Calculator · Excel'},
    desc:{es:'Plantilla GHG Protocol (Alcances 1, 2 y 3) para reporte ESG. Versión en inglés.', en:'GHG Protocol template (Scopes 1, 2 & 3) for SME ESG reporting. English edition.'},
    url:{es:'https://www.etsy.com/es/listing/4447014903/carbon-footprint-spreadsheet-corporate', en:'https://www.etsy.com/es/listing/4447014903/carbon-footprint-spreadsheet-corporate'}},
];
